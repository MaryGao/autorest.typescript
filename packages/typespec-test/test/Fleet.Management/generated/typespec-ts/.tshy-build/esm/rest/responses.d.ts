...
import { PagedOperationOutput, ErrorResponseOutput, CatalogOutput, CatalogListResultOutput, CountDevicesResponseOutput, DeploymentListResultOutput, DeviceGroupListResultOutput, PagedDeviceInsightOutput, DeviceListResultOutput, CertificateOutput, CertificateListResultOutput, CertificateChainResponseOutput, ProofOfPossessionNonceResponseOutput, ImageOutput, ImageListResultOutput, ProductOutput, ProductListResultOutput, DeviceGroupOutput, DeploymentOutput, DeviceOutput, SignedCapabilityImageResponseOutput } from "./outputModels.js";
...
export interface CatalogsListByResourceGroupDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
...
export interface CatalogsListBySubscriptionDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
...
export interface CatalogsListDeviceInsightsDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
...
export interface CertificatesRetrieveCertChainDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
export interface CertificatesRetrieveProofOfPossessionNonce200Response extends HttpResponse {
    status: "200";
    body: ProofOfPossessionNonceResponseOutput;
}
export interface CertificatesRetrieveProofOfPossessionNonceDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
...
/** Azure operation completed successfully. */
export interface ProductsGenerateDefaultDeviceGroups200Response extends HttpResponse {
    status: "200";
    body: DeviceGroupListResultOutput;
}
export interface ProductsGenerateDefaultDeviceGroupsDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
...
export interface DeviceGroupsCreateOrUpdateDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** The final response for long-running createOrUpdate operation */
export interface DeviceGroupsCreateOrUpdateLogicalResponse extends HttpResponse {
    status: "200";
    body: DeviceGroupOutput;
}
/** Azure operation completed successfully. */
...
export interface DeploymentsListByDeviceGroupDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
...
/** Azure operation completed successfully. */
export interface DevicesGenerateCapabilityImage200Response extends HttpResponse {
    status: "200";
...
/** Resource operation accepted. */
export interface DevicesGenerateCapabilityImage202Response extends HttpResponse {
    status: "202";
    headers: RawHttpHeaders & DevicesGenerateCapabilityImage202Headers;
}
export interface DevicesGenerateCapabilityImageDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** The final response for long-running generateCapabilityImage operation */
export interface DevicesGenerateCapabilityImageLogicalResponse extends HttpResponse {
    status: "200";
    body: SignedCapabilityImageResponseOutput;
}
